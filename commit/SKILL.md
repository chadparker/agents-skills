---
name: commit
description: "Only use when the user explicitly invokes this skill by name to make a Git commit."
disable-model-invocation: true
metadata:
  author: Armin Ronacher
  source: https://github.com/mitsuhiko/agent-stuff/blob/122e2994adddb113c04764c5697217dae120fcc6/skills/commit/SKILL.md
  comparison-baseline: 122e2994adddb113c04764c5697217dae120fcc6
  license: Apache-2.0
  local-differences: Provenance metadata and per-skill LICENSE added; description and invocation policies changed to require explicit manual invocation; OpenAI agent metadata added.
---
